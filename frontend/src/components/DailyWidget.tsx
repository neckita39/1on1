    ...
    >
      <div className="flex items-center" style={{ gap: 10 }}>
        ...
        <div className="flex flex-col min-w-0" style={{ gap: 0 }}>
          <span className="truncate" style={{ fontSize: 13, fontWeight: 500, maxWidth: 140 }}>{current.name}</span>
        ...
        <button
          onClick={next}
          className="rounded-[8px] bg-primary text-white font-medium transition-colors hover:bg-primary-hover flex-none"
